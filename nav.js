(function() {
  ...
  if (!document.getElementById('light-mode-css')) {
    ...
    lmStyle.textContent = [
      ...
      '}',
      'body.light-mode nav,body.light-mode .site-nav{background:rgba(247,244,239,0.97)!important;border-bottom:1.5px solid #b8a898!important;}',
      'body.light-mode header{background:#f7f4ef!important;border-bottom:1.5px solid #b8a898!important;}',
      'body.light-mode .nav-logo,body.light-mode .logo{color:#7a5c1e!important;font-weight:400!important;}',
      'body.light-mode .nav-links a{color:#3d2e1a!important;font-weight:400!important;}',
      'body.light-mode .nav-links a:hover,body.light-mode .nav-links a.active{color:#7a5c1e!important;}',
      'body.light-mode .nav-burger span{background:#16120c!important;}',
      'body.light-mode .nav-drawer{background:#f0ebe2!important;border-left:1.5px solid #b8a898!important;}',
      'body.light-mode .nav-drawer-links a{color:#3d2e1a!important;border-bottom-color:#c8bdb0!important;}',
      'body.light-mode .nav-drawer-links a:hover{color:#7a5c1e!important;}',
      'body.light-mode .nav-close{color:#3d2e1a!important;}',
      'body.light-mode .nav-drawer-header{border-bottom:1.5px solid #b8a898!important;background:#f0ebe2!important;}',
      'body.light-mode footer{background:#ede8df!important;border-top:1.5px solid #b8a898!important;color:#6b5a40!important;}',
      'body.light-mode footer a{color:#7a5c1e!important;}',
      'body.light-mode #t-overlay{background:#f7f4ef!important;}',
      'body.light-mode #nav-user-dropdown{background:#ffffff!important;border:1px solid #b8a898!important;box-shadow:0 8px 32px rgba(0,0,0,0.12)!important;}',
      'body.light-mode #nav-user-dropdown a{color:#3d2e1a!important;border-bottom-color:#e0d8ce!important;}',
      'body.light-mode #nav-user-dropdown a:hover{color:#16120c!important;background:#f0ebe2!important;}',
      'body.light-mode .mini-type{background:#ede8df!important;border:1px solid #b8a898!important;color:#3d2e1a!important;}',
      'body.light-mode .lcard{background:#ffffff!important;border:1px solid #b8a898!important;}',
      'body.light-mode .lcard:hover{border-color:#7a5c1e!important;box-shadow:0 12px 40px rgba(0,0,0,0.08)!important;}',
      'body.light-mode h1,body.light-mode h2,body.light-mode h3{color:#16120c!important;}',
      'body.light-mode p,body.light-mode div,body.light-mode span,body.light-mode li{color:inherit;}',
      'body.light-mode .page-eyebrow{color:#7a5c1e!important;}',
      'body.light-mode .dim-name,body.light-mode .lcard-letter,body.light-mode .lcard-name{color:#16120c!important;}',
      'body.light-mode .dim-desc,body.light-mode .lcard-desc,body.light-mode .page-sub{color:#4a3c28!important;}',
      'body.light-mode .dim-num{color:#9a7530!important;}',
      'body.light-mode body::before{opacity:0!important;}',
      'body.light-mode a{color:inherit!important;text-decoration:none!important;}',
      'body.light-mode a:hover{color:var(--gold)!important;}',
      'body.light-mode .type-card{background:#ffffff!important;border-color:#b8a898!important;}',
      'body.light-mode .type-card *{color:#16120c!important;}',
      'body.light-mode .type-card:hover{border-color:#7a5c1e!important;box-shadow:0 12px 40px rgba(0,0,0,0.08)!important;}',
      'body.light-mode .card-code{color:#16120c!important;}',
      'body.light-mode .card-name{color:#16120c!important;font-weight:500!important;}',
      'body.light-mode .card-tagline{color:#4a3c28!important;}',
      'body.light-mode .card-arrow{color:#9a7530!important;}',
      'body.light-mode .hi{color:#7a5c1e!important;}',
      'body.light-mode .group-label,.group-row,.group-name,.group-desc{color:#16120c!important;}',
      'body.light-mode .group-desc{color:#4a3c28!important;}',
