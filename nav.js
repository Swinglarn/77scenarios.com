(function() {
  ...
  if (!document.getElementById('nav-design-css')) {
    ...
    ds.textContent = [
      ...
      'body.light-mode .logo-scenarios{color:#000000 !important;}',
  ...
  if (!document.getElementById('light-mode-css')) {
    ...
    lmStyle.textContent = [
      'body.light-mode{--bg:#ffffff;--surface:#ffffff;--surface2:#f0f0f0;--gold:#c9a84c;--gold-dim:#a8893a;--cream:#000000;--muted:#2a2018;--border:#c8c0b4;background:#ffffff !important;color:#000000 !important;}',
      ...
      'body.light-mode .nav-logo{color:#000000 !important;font-weight:500 !important;}',
      'body.light-mode .nav-links a{color:#111111 !important;}',
      'body.light-mode .nav-links a:hover,body.light-mode .nav-links a.active{color:#000000 !important;}',
      ...
      'body.light-mode .nav-burger span{background:#000000 !important;}',
      'body.light-mode .nav-drawer{background:#f5f5f5 !important;border-left:1px solid #c8c0b4 !important;}',
      'body.light-mode .nav-drawer-links a{color:#111111 !important;border-bottom-color:#e0e0e0 !important;}',
      'body.light-mode .nav-drawer-links a:hover{color:#000000 !important;}',
      'body.light-mode .nav-close{color:#111111 !important;}',
      'body.light-mode .nav-drawer-header{border-bottom:1px solid #c8c0b4 !important;background:#f5f5f5 !important;}',
      ...
      'body.light-mode #nav-user-dropdown a{color:#111111 !important;border-bottom-color:#e0e0e0 !important;}',
      'body.light-mode #nav-user-dropdown a:hover{color:#000000 !important;background:#f5f5f5 !important;}',
      ...
      'body.light-mode .type-card *{color:#000000 !important;}',
      'body.light-mode .type-card:hover{border-color:#c9a84c !important;box-shadow:0 12px 40px rgba(0,0,0,0.07) !important;}',
      'body.light-mode .card-name{color:#000000 !important;font-weight:500 !important;}',
      'body.light-mode .card-tagline{color:#2a2018 !important;}',
      'body.light-mode .card-arrow{color:#c9a84c !important;}',
      'body.light-mode .hi{color:#c9a84c !important;}',
      'body.light-mode .mini-type{background:#f0f0f0 !important;border:1px solid #c8c0b4 !important;color:#111111 !important;}',
      ...
      'body.light-mode .lcard-letter,.lcard-name{color:#000000 !important;}',
      'body.light-mode .lcard-desc{color:#2a2018 !important;}',
      'body.light-mode .dim-desc{color:#2a2018 !important;}',
      'body.light-mode .page-sub{color:#2a2018 !important;}',
      'body.light-mode .page-eyebrow{color:#c9a84c !important;}',
      'body.light-mode .dim-num{color:#c9a84c !important;}',
      'body.light-mode .group-label,.group-name{color:#000000 !important;}',
      'body.light-mode .group-desc{color:#2a2018 !important;}',
      'body.light-mode body::before{opacity:0 !important;}',
      'body.light-mode #theme-toggle-desktop{color:#9a8a7a;}',
      'body.light-mode #theme-toggle-mobile{color:#111111 !important;}',

      'body.light-mode .nav-right-slot a:not(.nav-cta){border-color:#c8c0b4 !important;color:#111111 !important;}',
      'body.light-mode #theme-toggle-desktop{color:#9a8a7a !important;}',
      'body.light-mode #nav-footer{background:#f0f0f0 !important;border-top-color:#c8c0b4 !important;}',
      'body.light-mode #nav-footer .footer-tagline{color:#4a3c2a !important;}',
      'body.light-mode #nav-footer .footer-links a{color:#2a2018 !important;}',
      'body.light-mode #nav-footer .footer-links a:hover{color:#000000 !important;}',
      'body.light-mode #nav-footer .footer-copy{color:#6b5c3e !important;}',
      /* ── New elements: type pages, compat pages, legal pages ── */
      'body.light-mode .faq-item{border-bottom-color:#c8c0b4 !important;}',
      'body.light-mode .faq-q{color:#000000 !important;font-weight:500 !important;}',
      'body.light-mode .faq-a{color:#1e150a !important;}',
      'body.light-mode .rarity-badge{background:#ffffff !important;border-color:#c8c0b4 !important;color:#2a2018 !important;}',
      ...
      'body.light-mode .score-legend{color:#2a2018 !important;}',
      ...
      'body.light-mode .tpc-code{color:#000000 !important;}',
      'body.light-mode .tpc-name{color:#000000 !important;}',
      'body.light-mode .tpc-tagline{color:#2a2018 !important;}',
      'body.light-mode .tpc-arrow{color:#a8893a !important;}',
      'body.light-mode .related-pill{background:#ffffff !important;border-color:#c8c0b4 !important;color:#2a2018 !important;}',
      ...
      'body.light-mode .sim-code{color:#000000 !important;}',
      'body.light-mode .sim-name{color:#2a2018 !important;}',
      'body.light-mode .info-box{background:#ffffff !important;border-color:#c8c0b4 !important;}',
      'body.light-mode .info-box p{color:#1e150a !important;}',
      'body.light-mode .data-list li{color:#1e150a !important;}',
      'body.light-mode .prose{color:#1e150a !important;}',
      'body.light-mode .warning-box{background:rgba(138,109,46,0.08) !important;border-color:rgba(138,109,46,0.3) !important;}',
      'body.light-mode .warning-box p{color:#1a1000 !important;}',
      'body.light-mode .contact-form input,body.light-mode .contact-form textarea,body.light-mode .contact-form select{background:#ffffff !important;border-color:#c8c0b4 !important;color:#000000 !important;}',
