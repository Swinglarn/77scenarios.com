(function() {
  ...
  if (!document.getElementById('light-mode-css')) {
    ...
    lmStyle.textContent = [
      'body.light-mode{--bg:#f5f2ed;--surface:#e8e3db;--surface2:#ddd8cf;--gold:#8a6d2e;--gold-dim:#6b4820;--cream:#1a1208;--muted:#5c4e38;--border:#ccc4b4;background:#f5f2ed!important;color:#1a1208!important;}',
      'body.light-mode nav,body.light-mode .site-nav{background:rgba(245,242,237,0.95)!important;border-bottom-color:#ccc4b4!important;}',
      'body.light-mode header{background:#f5f2ed!important;border-bottom-color:#ccc4b4!important;}',
      'body.light-mode .nav-logo,body.light-mode .logo{color:#8a6d2e!important;}',
      'body.light-mode .nav-links a{color:#5c4e38!important;}',
      'body.light-mode .nav-links a:hover,body.light-mode .nav-links a.active{color:#1a1208!important;}',
      'body.light-mode .nav-burger span{background:#5c4e38!important;}',
      'body.light-mode .nav-drawer{background:#ede8df!important;border-left-color:#ccc4b4!important;}',
      'body.light-mode .nav-drawer-links a{color:#5c4e38!important;border-bottom-color:#ccc4b4!important;}',
      'body.light-mode .nav-close{color:#5c4e38!important;}',
      'body.light-mode .nav-drawer-header{border-bottom-color:#ccc4b4!important;}',
      'body.light-mode footer{background:#f5f2ed!important;border-top-color:#ccc4b4!important;color:#5c4e38!important;}',
      'body.light-mode footer a{color:#8a6d2e!important;}',
      'body.light-mode #t-overlay{background:#f5f2ed!important;}',
      'body.light-mode #nav-user-dropdown{background:#ede8df!important;border-color:#ccc4b4!important;}',
      'body.light-mode #nav-user-dropdown a{color:#5c4e38!important;border-bottom-color:#ccc4b4!important;}',
      'body.light-mode #nav-user-dropdown a:hover{color:#1a1208!important;background:rgba(0,0,0,0.04)!important;}',
      'body.light-mode .mini-type{background:#ddd8cf!important;border-color:#ccc4b4!important;color:#5c4e38!important;}',
      'body.light-mode .lcard{background:#e8e3db!important;border-color:#ccc4b4!important;}',
      'body.light-mode .lcard:hover{box-shadow:0 20px 50px rgba(0,0,0,0.1)!important;}',
      'body.light-mode body::before{opacity:0.02!important;}',
