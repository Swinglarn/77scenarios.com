(function() {
  ...
  function injectSearchBar() {
    ...
    s.textContent = [
      ...
      '#srch-input{width:100%;box-sizing:border-box;background:rgba(255,255,255,0.05);border:1px solid #272d35;border-radius:8px;padding:8px 74px 8px 33px;font-size:16px;line-height:1.2;color:#ede8df;font-family:inherit;outline:none;transition:border-color 0.15s,background 0.15s;-webkit-appearance:none;appearance:none;}',
      '#srch-input:focus{border-color:#3e4650;background:rgba(255,255,255,0.08);}',
