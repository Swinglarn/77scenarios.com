(function() {
  ...
  if (!document.getElementById('nav-design-css')) {
    ...
    ds.textContent = [
      ...
      '@media(max-width:960px){.nav-drawer-links{max-height:calc(100vh - 56px) !important;}}',
  ...
  if (!document.getElementById('light-mode-css')) {
    ...
    lmStyle.textContent = [
      ...
      'body.light-mode .nav-drawer-header{border-bottom:1px solid #d0d7e3 !important;background:#f4f5f7 !important;}',
      ...
      'body.light-mode .type-card{background:#ffffff !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.07) !important;}',
      'body.light-mode .type-card *{color:#1e2d4a !important;}',
      'body.light-mode .type-card:hover{border-color:#1e2d4a !important;box-shadow:0 4px 20px rgba(30,45,74,0.14) !important;}',
      'body.light-mode .card-name{color:#1e2d4a !important;font-weight:500 !important;}',
      'body.light-mode .card-tagline{color:#4a5568 !important;font-weight:400 !important;}',
      ...
      /* ── Letter cards ── */
      'body.light-mode .lcard{background:#ffffff !important;border:1px solid #d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.07) !important;}',
      'body.light-mode .lcard:hover{border-color:#1e2d4a !important;box-shadow:0 4px 20px rgba(30,45,74,0.14) !important;}',
      /* FIX: both selectors must be scoped to body.light-mode or dark mode gets dark text */
      'body.light-mode .lcard-letter,body.light-mode .lcard-name{color:#1e2d4a !important;font-weight:500 !important;}',
      ...
      /* ── Noise texture off ── */
      'body.light-mode::before{opacity:0 !important;}',
      'body.light-mode .glow{opacity:0 !important;}',
      /* ── Theme toggles ── */
      ...
      /* ── Compat score blocks ── */
      'body.light-mode .score-block{background:#ffffff !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.07) !important;}',
      ...
      /* ── Type pair cards ── */
      'body.light-mode .type-pair-card{background:#ffffff !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.07) !important;}',
      'body.light-mode .type-pair-card:hover{border-color:#1e2d4a !important;box-shadow:0 4px 20px rgba(30,45,74,0.14) !important;}',
      'body.light-mode .tpc-code{color:#1e2d4a !important;}',
      'body.light-mode .tpc-name{color:#1e2d4a !important;font-weight:500 !important;}',
      ...
      'body.light-mode .similar-card{background:#ffffff !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.07) !important;}',
      'body.light-mode .similar-card:hover{border-color:#1e2d4a !important;box-shadow:0 4px 20px rgba(30,45,74,0.14) !important;}',
      'body.light-mode .sim-code{color:#1e2d4a !important;}',
      'body.light-mode .sim-name{color:#4a5568 !important;}',
      /* ── Info / prose / legal boxes ── */
      'body.light-mode .info-box{background:#ffffff !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.07) !important;}',
      'body.light-mode .info-box p{color:#1e2d4a !important;}',
      ...
      'body.light-mode .contact-card{background:#ffffff !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.07) !important;}',
      /* ── vs pages ── */
      ...
      'body.light-mode .vs-fn-col{background:#ffffff !important;border-color:#d0d7e3 !important;}',
      ...
      'body.light-mode .vs-table tbody tr:nth-child(even){background:#f4f5f7 !important;}',
      ...
      'body.light-mode .vs-overlap-item{background:#ffffff !important;border-color:#d0d7e3 !important;color:#1e2d4a !important;}',
      'body.light-mode .vs-tell-item{background:#ffffff !important;border:1px solid #d0d7e3 !important;}',
      'body.light-mode .vs-tell-title{color:#141210 !important;}',
      'body.light-mode .vs-tell-body{color:#5a5550 !important;}',
      'body.light-mode .vs-famous-col{background:#ffffff !important;border-color:#d0d7e3 !important;}',
      'body.light-mode .vs-famous-col-title{color:#7a5c1e !important;}',
      'body.light-mode .vs-famous-name{color:#141210 !important;}',
      'body.light-mode .vs-quiz{background:#ffffff !important;border-color:#d0d7e3 !important;}',
      ...
      'body.light-mode .vs-pair-card{background:#ffffff !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.07) !important;}',
      'body.light-mode .vs-pair-card:hover{border-color:#1e2d4a !important;box-shadow:0 4px 20px rgba(30,45,74,0.14) !important;}',
      ...
      'body.light-mode .db-card-name{color:#1e2d4a !important;font-weight:500 !important;}',
      ...
      'body.light-mode .db-card:hover,body.light-mode .type-card:hover,body.light-mode .lcard:hover,body.light-mode .related-card:hover,body.light-mode .fncard:hover{box-shadow:0 4px 20px rgba(30,45,74,0.14) !important;border-color:#1e2d4a !important;}',
      ...
      'body.light-mode .score-card,body.light-mode .verdict-box,body.light-mode .cta-block,body.light-mode .result-card,body.light-mode .thread-item,body.light-mode .auth-notice{background:#ffffff !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.07) !important;}',
      'body.light-mode .callout{background:#ffffff !important;border-color:#d0d7e3 !important;border-left-color:var(--gold-dim) !important;box-shadow:0 1px 4px rgba(30,45,74,0.07) !important;}',
      'body.light-mode .warning-box{background:rgba(201,168,76,0.06) !important;border-color:rgba(201,168,76,0.3) !important;}',
      'body.light-mode .contact-card:hover,body.light-mode .thread-item:hover,body.light-mode .result-card:hover{box-shadow:0 4px 20px rgba(30,45,74,0.14) !important;border-color:#1e2d4a !important;}',

      /* Form inputs in light mode */
      'body.light-mode .field-input,body.light-mode .field input,body.light-mode .field textarea,body.light-mode .field select,body.light-mode .form-input,body.light-mode .form-select,body.light-mode .form-textarea{background:#ffffff !important;border-color:#d0d7e3 !important;color:#1e2d4a !important;}',
      ...
      'body.light-mode #srch-input{background:#ffffff !important;border-color:#d0d7e3 !important;color:#1e2d4a !important;}',
  ...
  function injectFooter() {
    ...
    footer.innerHTML = [
      ...
      '  <span class="footer-copy">&copy; ' + year + ' 77 Scenarios. ' + t.copy + ' &middot; <a href="https://webbitar.com" target="_blank" style="color:inherit;text-decoration:none;opacity:0.8;">Owned &amp; operated by Webbitar</a></span>',
  ...
  function initNav() {
    ...
    if (!nav) {
      ...
      baseStyle.textContent = [
        ...
        '@media(max-width:1200px){nav.site-nav{padding:0 20px;}}',
        ...
        '@media(max-width:1200px){nav.site-nav .nav-links{gap:18px;}}',
        ...
        '@media(max-width:960px){nav.site-nav .nav-links{display:none;}nav.site-nav .nav-burger{display:flex;}}',
      ].join('');
