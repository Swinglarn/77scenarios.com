(function() {
  ...
  if (!document.getElementById('light-mode-css')) {
    ...
    lmStyle.textContent = [
      ...
      'body.light-mode .type-card{background:#ffffff !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.06) !important;}',
      ...
      /* ── Letter cards ── */
      'body.light-mode .lcard{background:#ffffff !important;border:1px solid #d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.06) !important;}',
      ...
      /* ── Type pair cards ── */
      'body.light-mode .type-pair-card{background:#ffffff !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.06) !important;}',
      ...
      'body.light-mode .similar-card{background:#ffffff !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.06) !important;}',
      ...
      'body.light-mode .db-card,body.light-mode .fncard,body.light-mode .intro-box,body.light-mode .cta-box,body.light-mode .post-body,body.light-mode .reply-card,body.light-mode .box,body.light-mode .growth-box,body.light-mode .opp-block,body.light-mode .fd-box,body.light-mode .famous-card,body.light-mode .type-mini,body.light-mode .modal,body.light-mode .actor-chip,body.light-mode .universe-chip{background:#f0f3f8 !important;border-color:#d0d7e3 !important;box-shadow:0 1px 4px rgba(30,45,74,0.06) !important;}',
