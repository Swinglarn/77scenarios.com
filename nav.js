(function() {
  ...
  if (!document.getElementById('light-mode-css')) {
    ...
    lmStyle.textContent = [
      ...
      'body.light-mode .nav-drawer{background:#f0f0ed!important;border-left:1px solid #c8c0b4!important;}',
      ...
      'body.light-mode .nav-drawer-header{border-bottom:1px solid #c8c0b4!important;background:#f0f0ed!important;}',
      ...
      'body.light-mode #nav-user-dropdown a:hover{color:#0f0d0a!important;background:#f0f0ed!important;}',
      ...
      'body.light-mode .card-arrow,.card-arrow{color:#c9a84c!important;}',
      ...
      'body.light-mode .lcard-desc,.dim-desc,.page-sub{color:#4a4035!important;}',
      'body.light-mode .page-eyebrow,.dim-num{color:#c9a84c!important;}',
