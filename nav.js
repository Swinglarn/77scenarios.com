(function() {
  ...
  if (!document.getElementById('light-mode-css')) {
    ...
    lmStyle.textContent = [
      ...
      '}',
      'body.light-mode nav,body.light-mode .site-nav{background:rgba(240,235,226,0.97)!important;border-bottom:1.5px solid #b8a898!important;}',
      'body.light-mode header{background:#f0ebe2!important;border-bottom:1.5px solid #b8a898!important;}',
      'body.light-mode .nav-logo,body.light-mode .logo{color:#16120c!important;font-weight:500!important;}',
      ...
      'body.light-mode footer{background:#e5dfd5!important;border-top:1.5px solid #b8a898!important;color:#6b5a40!important;}',
      'body.light-mode footer a{color:#7a5c1e!important;}',
      'body.light-mode #t-overlay{background:#f0ebe2!important;}',
      ...
      'body.light-mode .card-arrow{color:#b8860b!important;}',
      'body.light-mode .hi{color:#b8860b!important;}',
